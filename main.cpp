...
char name[]="RUBIK'S CUBE\0";
char college[]="CMR INSTITUTE OF TECHNOLOGY\0";
char dept[]="DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING\0";
char heading[]="18CSL67 - COMPUTER GRAPHICS WITH MINI PROJECT LABORATORY\0";
char row1[]="Created By                                                                Guided By\0";
char row2[]="Mangesh Shrestha (1CR20CS108)                          Prof.Manju,\0";
char row3[]="Manjil KC (1CR20CS110)                                     Prof.Shivraj,\0";
...
glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, dash[i]);
glPopMatrix();
...
glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, row1[i]);
glPopMatrix();
...
glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, row2[i]);
glPopMatrix();
...
glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, row3[i]);
glPopMatrix();
